#!/usr/bin/env node
/**
 * Stop Hook: Batch typecheck all JS/TS files edited this response
 *
 * Cross-platform (Windows, macOS, Linux)
 *
 * Reads the accumulator written by post-edit-accumulator.js and typechecks
 * all edited files in one pass: groups .ts/.tsx files by tsconfig dir for a
 * single tsc --noEmit per tsconfig. The accumulator is cleared on read so
 * repeated Stop calls do not double-process files.
 *
